...
## Hecho recientemente
- Movimientos, Gasto por categoría y Evolución mensual comparten un único catálogo visual: texto, icono y colores coherentes, con barras de gasto por categoría y series mensuales que reutilizan la misma familia cromática. El color nunca es la única señal y los iconos decorativos no duplican contenido en lectores de pantalla. Contrato fuente añadido; validación pendiente de permiso. Ver [[project_accessibility_and_investment_price_ux]].
