...
- [UX Snapshots Feedback](feedback_ux_snapshots.md) — Ejecutar ux:snapshots:headed tras cambios de UI antes de cerrar tarea
- [Commit Confirmation](feedback_commit_confirmation.md) — Pedir confirmación explícita antes de cualquier git commit
- [Commits y Graphify](feedback_commits_and_graphify.md) — Nunca commits automáticos (solo stage); graphify SOLO con permiso explícito (nunca automático)
