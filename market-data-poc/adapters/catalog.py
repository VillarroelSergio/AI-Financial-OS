"""Reusable public dataset adapter for catalog/health coverage."""
import time
...
from models.assets import MacroSeries, MarketNews
    ...
    def _record(self, response):
        ...
        if self.category == "news":
            return MarketNews(
                ...
                title=f"{self.name} public feed reachable",
                url=self.base_url,
